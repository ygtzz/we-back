...
import AjaxPlugin from './widget/plugins/ajax';
import VueLazyload from 'vue-lazyload'; // 引入图片懒加载模块
import inputPrice from './widget/directive/input-price';
import inputQuantity from './widget/directive/input-quantity';
import vueWaves from './widget/directive/waves';// 水波纹指令
