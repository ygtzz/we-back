...
<script>
  import BackToTop from 'index/widget/BackToTop/index.vue';
  import Sticky from 'index/widget/Sticky/index.vue';
  import {CropAndUpload} from 'index/widget/ImageUpload';
  import {SingleSelectGoodDialog, MultiSelectGoodListDialog} from 'index/widget/GoodListDialog/index';
